...
class BasicConv2dTranspose(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, batch_norm=False, actv=False, kernel=2, stride=2, padding=0):
        ...
        self.conv = nn.ConvTranspose2d(in_channels=in_channels, out_channels=out_channels, kernel_size=kernel,
                                       stride=stride,
...
class PoseDecoder(nn.Module):
    ...
    def __init__(self, in_ch, out_chn):
        ...
        self.Conv2dT_2 = BasicConv2dTranspose(1024 + 608, out_chn, kernel=8, stride=4, padding=2)
    ...
    def features(self, x):
        ...
        inception_3a_double_3x3_reduce_bn_out = self.inception_31_double_3x3_reduce_bn(
            inception_3a_double_3x3_reduce_out)
        inception_3a_relu_double_3x3_reduce_out = self.inception_31_relu_double_3x3_reduce(
...
class Inception(nn.Module):
    def __init__(self, out_chn):
        ...
        self.pd1 = PoseDecoder(192, out_chn=out_chn)
        self.pd2 = PoseDecoder(192 + out_chn, out_chn=out_chn)
        #self.pd3 = PoseDecoder(192 + out_chn, out_chn=out_chn)
        # self.pd4 = PoseDecoder(192 + out_chn)
